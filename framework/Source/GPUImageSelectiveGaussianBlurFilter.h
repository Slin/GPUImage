...
@interface GPUImageSelectiveGaussianBlurFilter : GPUImageTwoPassTextureSamplingFilter
{
...
@property (nonatomic, assign) int focusMode;
@property (nonatomic, assign) CGPoint focusPosition;
@property (nonatomic, assign) float focusRadius;
@property (nonatomic, assign) float focusFallOffRate;
@property (nonatomic, assign) CGPoint pixelScale;
